...
$PHPTHUMB_CONFIG['error_image_width']           = 420;      // default width for error images
...
$PHPTHUMB_CONFIG['error_bgcolor']               = '000000'; // background color of error message images
$PHPTHUMB_CONFIG['error_textcolor']             = 'ffffff'; // color of text in error messages
