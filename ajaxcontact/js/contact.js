...
var whiteSpace = /^[\s]+$/;
	if ( posText.value == '' || whiteSpace.test(posText.value) ) {
		alert("You're trying to send an Empty Email. Fill in all required fields.");
	}
	else if ( posEmail.value == '' && strCC.checked == true ) {
		alert("You trying to CC yourself, but you didn't leave your email address.");
		alert("Just for that...");
...
function sendPosEmail () {
	...
	var page = my_pligg_base + "/modules/ajaxcontact/scripts/xmlHttpRequest.php?contact=true&xml=true";
